 ...
 */
#if (P2P_SERVER1 != 0)
static const char a_LocalName[] = {AD_TYPE_COMPLETE_LOCAL_NAME ,'R','e','m','o','t','e','s','1'};
...
void APP_BLE_Init(void)
{
  ...
  SHCI_C2_Ble_Init_Cmd_Packet_t ble_init_cmd_packet =
  {
    ...
    {0,                                 /** pBleBufferAddress not used */
	 ...
	 //8 Total Services available
     CFG_BLE_NUM_GATT_SERVICES,

	 //Storage area size for the attribute values, May have to update ------------------------------
	 ...
	 //Maybe have to update -------------------------------
     CFG_BLE_PREPARE_WRITE_LIST_SIZE,

	 //Allocated memory blocks for the ble stack
	 ...
	 //Sleep clock accuract in central mode
     CFG_BLE_CENTRAL_SCA,

	 //Low speed clock source
     CFG_BLE_LS_SOURCE,

	 //Maximum duration of a slace connection event.
     CFG_BLE_MAX_CONN_EVENT_LENGTH,

	 //high speed osc start up time
	 ...
	 //Max number of connection oriented channels
     CFG_BLE_MAX_COC_INITIATOR_NBR,

	 //Minimum transmit power in dBm, set to -50dBm
	 ...
	 //255 bytes of advertisement data
  ...
  {
	  BLE_DBG_APP_MSG("  Fail   : SHCI_C2_BLE_Init command, result: 0x%02x\n\r", status);
